...
const translations: Record<string, TranslationTree> = {
  en: {
    ...
    timeline: {
      ...
      selectJobPrompt: "Select a job to view its timeline.",
      jobSelectorLabel: "Job",
      jobSelectorPlaceholder: "Select a job…",
      noJobsAvailable: "No jobs in this company yet — create one from the Projects tab.",
  ...
  es: {
    ...
    timeline: {
      ...
      selectJobPrompt: "Selecciona un trabajo para ver su cronología.",
      jobSelectorLabel: "Trabajo",
      jobSelectorPlaceholder: "Selecciona un trabajo…",
      noJobsAvailable: "Aún no hay trabajos en esta empresa — crea uno desde la pestaña Proyectos.",
